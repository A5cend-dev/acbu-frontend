...
export default function LendingPage() {
    ...
    useEffect(() => {
        ...
        lendingApi
            .getLendingBalance(apiLender, opts)
            .then((res) => {
                setLendingBalance(res.balance);
            })
            .catch(() => setLendingBalance(null))
                    ...
                    {(lendingLoading || lendingBalance != null) && (
                        <Card className="border-border bg-gradient-to-br from-primary/20 to-secondary/10 p-5 mb-4">
                            ...
                            <p className="text-2xl font-bold text-foreground">
                                {lendingLoading
                                    ? "—"
                                    : formatAmount(lendingBalance)}
                            </p>
                            <div className="flex gap-2 mt-3">
                                <Link href="/lending/deposit">
                                    <Button
                                        size="sm"
                                        variant="outline"
                    ...
                    <div>
                        ...
                        <Card className="border-border bg-gradient-to-br from-primary/20 to-secondary/10 p-5">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-4">
                                <div>
                                    ...
                                    <p className="text-lg font-bold text-foreground">
                                        AFK{" "}
                                        {formatAmount(mockActiveLoan.balance)}
                                    </p>
                                </div>
                                <div>
                                    <p className="text-xs text-muted-foreground mb-1">
                            ...
                            <div className="flex items-center gap-2 text-xs text-muted-foreground bg-muted p-2 rounded">
                                ...
                                <span>
                                    Next payment due{" "}
                                    {mockActiveLoan.nextPaymentDate}
                                </span>
                            </div>
                        </Card>
                    </div>
                    ...
                    <Card className="border-border bg-muted p-4">
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Minimum 300 credit score. Some products
